...
export const ProductItem: FunctionComponent<ProductItemProps> = ({
  ...
  return (
    <div className="max-w-full md:max-w-[320px] w-full py-4 flex flex-col justify-center items-center gap-2 border border-slate-500 rounded-lg">
      <div className="w-full flex flex-row md:flex-col">
        ...
        <div className="flex-1 w-full px-4 md:px-8">
          <h3 className="text-base md:text-lg line-clamp-2 text-wrap">{title}</h3>
          ...
          <div className="flex flex-row gap-2 items-center align-middle">
            <RatingStars
              ...
              rating={rating}
            />
            <span className="text-sm md:text-base align-middle">{rating.toFixed(2)}</span>
          </div>
          <strong className="text-lg md:text-2xl">USD$ {showPrice().toFixed(2)}</strong>
